		...
		<div class="container-fluid">
					...
					<nav class="navbar navbar-primary" role="navigation" >
							<div class="container-fluid" >
								...
								<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
									...
									<a class="navbar-brand" href="<?php echo site_url('login') ?>">Login Page</a>
									<a class="navbar-brand" href="<?php echo site_url('registrasi') ?>">Daftar</a>
								</div>
					...
					<?php echo form_open_multipart('registrasi/create'); ?>
								...
								<div class="form-group">
									...
									<input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Konfirmasi Password"  value="<?php echo set_value('confirm_password'); ?>">
